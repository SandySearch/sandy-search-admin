    ...
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
        ...
        imports: [
            ...
            __WEBPACK_IMPORTED_MODULE_25__agm_core__["a" /* AgmCoreModule */].forRoot({
                apiKey: __WEBPACK_IMPORTED_MODULE_8__credentials__["b" /* googleMapsKey */]
            })
        ],
...
var EventDetailsComponent = (function () {
    function EventDetailsComponent(firebaseService, router, route) {
        ...
        this.router = router;
        this.route = route;
        this.zoom = 3; // eslint-disable-line no-undef
        this.paths = [{ lat: 42.052224, lng: -77.050342 }, { lat: 42.064306, lng: -77.031790 }, { lat: 42.075951, lng: -77.054554 }, { lat: 42.063236, lng: -77.072506 }, { lat: 42.052224, lng: -77.050342 }];
    }
    EventDetailsComponent.prototype.ngOnInit = function () {
        ...
        this.firebaseService.getEventDetails(this.id).subscribe(function (event_details) {
            ...
            // mid of east line?
            _this.lat = ((_this.event_details.nePointLat - _this.event_details.sePointLat) / 2) + _this.event_details.sePointLat;
            // mid of north line?
            _this.lng = ((_this.event_details.nwPointLon - _this.event_details.nePointLon) / 2) + _this.event_details.nePointLon;
            // polygon points
            _this.paths = [
                {
                    lat: _this.event_details.nePointLat,
                    lng: _this.event_details.nePointLon
                },
                {
                    lat: _this.event_details.sePointLat,
                    lng: _this.event_details.sePointLon
                },
                {
                    lat: _this.event_details.swPointLat,
                    lng: _this.event_details.swPointLon
                },
                {
                    lat: _this.event_details.nwPointLat,
                    lng: _this.event_details.nwPointLon
                }
            ];
        });
    };
...
var ListingComponent = (function () {
    function ListingComponent(firebaseService, router, route) {
        ...
        this.router = router;
        this.route = route;
        this.zoom = 10; // eslint-disable-line no-undef
    }
    ListingComponent.prototype.ngOnInit = function () {
        ...
        this.firebaseService.getListingDetails(this.id).subscribe(function (listing) {
            ...
            _this.lat = _this.listing.lat;
            _this.lng = _this.listing.lon;
        });
    };
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return googleMapsKey; });
// sandy-demo
// sandy-demo
var firebaseConfig = {
